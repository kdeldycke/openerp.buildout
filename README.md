...
1. Install required dependencies:
        ...
        $ sudo apt-get update
        $ sudo apt-get install sudo python-dev gcc bzr subversion git postgresql-9.1 python-ldap python-libxslt1 libxslt1-dev libyaml-dev libjpeg62-dev zlib1g-dev libfreetype6-dev liblcms1-dev libxml2-dev libpq-dev
